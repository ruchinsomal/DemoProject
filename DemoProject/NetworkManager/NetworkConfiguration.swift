...
//  DemoProject
//
//  Created by Ruchin Somal on 14/09/17.
...
func postRequestWithImage(url: String, params: [String: AnyObject]?,imageData: Array<Data>, result: @escaping (JSON?, _ error: NSError?, _ statuscode: Int) -> ()) {
